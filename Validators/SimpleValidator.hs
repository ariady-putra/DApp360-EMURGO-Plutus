...
import qualified Ledger.Scripts      as Scripts               -- Low Level Typed Validator  after Vasil is on Plutus.Script.Utils.V1.Scripts
...
alwaysSucceeds :: BuiltinData -> BuiltinData -> BuiltinData -> ()  -- the value of this function is on its side effects
...
validator :: Validator
validator = mkValidatorScript $$(PlutusTx.compile [|| alwaysSucceeds ||]) -- Validator {<script>}
